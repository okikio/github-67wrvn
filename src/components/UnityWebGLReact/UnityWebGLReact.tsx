...
const App = () => {
  const {
    ...
    loaderUrl: '/build/Pummel16May2nd.loader.js',
    dataUrl: '/build/Pummel16May2nd.data',
    frameworkUrl: '/build/Pummel16May2nd.framework.js',
    codeUrl: '/build/Pummel16May2nd.wasm',
